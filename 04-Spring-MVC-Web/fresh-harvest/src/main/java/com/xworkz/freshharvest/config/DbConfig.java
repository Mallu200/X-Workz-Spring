...
public class DbConfig {
    ...
    public DbConfig() {
        // Trace to confirm the FreshHarvest Database Configuration is being loaded during startup
        System.out.println("Created DbConfig: Initializing Hibernate & DB settings for FreshHarvest.");
    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.xworkz.freshharvest.entity"); // Scans for @Entity classes in FreshHarvest
