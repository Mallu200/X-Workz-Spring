...
<head>
    <meta charset="UTF-8">
    <title>AutoCare | Add Service Record</title>
    <style>
        ...
        h2 { color: #1a237e; text-align: center; margin-bottom: 25px; text-transform: uppercase; letter-spacing: 1px; }
        ...
        .btn-submit {
            background-color: #1a237e; color: white; border: none; padding: 16px;
        ...
        .nav-link { display: block; text-align: center; margin-top: 20px; color: #455a64; text-decoration: none; font-size: 14px; }
    </style>
</head>
<body>
...
<div class="form-container">
    ...
    <%-- Image of Spring MVC form data binding to DTO --%>


    <form:form action="${pageContext.request.contextPath}/vehicle/save" method="POST" modelAttribute="vehicleDto">

        <%-- ID must be present for the controller logic to work --%>
        <form:hidden path="id" />

        <div class="form-group">
            <label>Owner Name</label>
            <form:input path="ownerName" placeholder="Enter owner's full name" />
            <form:errors path="ownerName" cssClass="error" />
        </div>

        <div class="form-group">
            <label>License Plate</label>
            <form:input path="licensePlate" placeholder="e.g. KA01AB1234" />
            <form:errors path="licensePlate" cssClass="error" />
        </div>

        <div class="form-group">
            <label>Vehicle Model</label>
            <form:input path="modelName" placeholder="e.g. Swift, Fortuner, City" />
            <form:errors path="modelName" cssClass="error" />
        </div>

        <div class="form-group">
            <label>Current Mileage (km)</label>
            <form:input path="currentMileage" type="number" placeholder="Enter current odometer reading" />
        ...
        <div class="form-group">
            ...
            <form:select path="serviceType">
                <form:option value="" label="-- Select Service --" />
    ...
    <a href="${pageContext.request.contextPath}/vehicle/viewAll" class="nav-link">← Back to Records</a>
</div>
