...
// This class acts as the entrance to the WonderWand application, replacing the traditional web.xml
public class AppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {

    @Override // Configures the 'Root' context (Services, Repositories, and Database beans)
    protected Class<?>[] getRootConfigClasses() {
        // Trace to confirm that the WonderWand backend/data layer is being initialized
        System.out.println("AppInitializer: Loading Root Application Context (DbConfig) for WonderWand...");
    ...
    protected Class<?>[] getServletConfigClasses() {
        // Trace to confirm that the WonderWand web/MVC layer is being initialized
        System.out.println("AppInitializer: Loading Servlet Application Context (WebConfig) for WonderWand...");
    ...
    protected String[] getServletMappings() {
        ...
        System.out.println("AppInitializer: Mapping DispatcherServlet to '/' for the WonderWand project.");
